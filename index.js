...
console.log(color('> WA NUMBER: +233272122619 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "233272122619@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["233272122619@s.whatsapp.net","233272122619@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "233272122619@s.whatsapp.net"
